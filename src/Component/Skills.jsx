...
const Skills = () => {
  ...
  return (
    <div className="border-b border-slate-700" id="Skills">
      <div className="text-white mt-16 bg-black pb-8" id="Skills">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mb-8">
          ...
          <div className="border border-slate-700 shadow-md shadow-slate-700 p-4" data-aos="zoom-in-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
            <div>
              <h2 className="text-center mb-6 uppercase tracking-widest text-4xl font-bold">
                Frontend
              </h2>
              <div className=" grid grid-cols-2 gap-4 text-center">
                <div className="bg-slate-800 uppercase md:px-4 py-3 rounded-full tracking-wider font-semibold md:text-2xl">
                  <IoLogoHtml5 size={40} className="inline me-4" />
                  html5
                </div>
                <div className="bg-slate-800 uppercase px-4 py-3 rounded-full tracking-wider font-semibold md:text-2xl">
